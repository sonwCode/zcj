...
# ★ Camoufox Firefox CDP 补丁：修复 setDefaultViewport 协议错误
# 必须在导入其他 camoufox 相关模块之前加载
try:
    from core.camoufox_viewport_patch import *  # noqa: F401, F403
    print("[OK] Camoufox CDP 补丁已加载")
except ImportError:
    pass
...
from api.mailbox_pool import router as mailbox_pool_router
...
app.include_router(mailbox_pool_router, prefix="/api")
