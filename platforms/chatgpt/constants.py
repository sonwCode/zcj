...
OPENAI_API_ENDPOINTS = {
    ...
    "verify_password": f"{OPENAI_AUTH}/api/accounts/password/verify",
    "add_email_send": f"{OPENAI_AUTH}/api/accounts/add-email/send",
    ...
    "send_phone_otp": f"{OPENAI_AUTH}/api/accounts/phone-otp/send",
    "send_add_phone": f"{OPENAI_AUTH}/api/accounts/add-phone/send",
    "validate_phone_otp": f"{OPENAI_AUTH}/api/accounts/phone-otp/validate",
