...
def build_phone_callbacks(ctx: RegistrationContext, *, service: str | None = None):
    ...
    generic_max_price = next(
        (
            value
            for value in (
                extra.get("sms_max_price"),
                extra.get("max_price"),
                merged.get("sms_max_price"),
    ...
    if generic_max_price is not None:
        merged["sms_max_price"] = generic_max_price
