...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "local_gmail_pool",
        "label": "本地谷歌邮箱池",
        "description": "导入 Gmail 邮箱池，支持 email----验证码 API URL 格式；用于用户自有 Gmail 收取验证码。",
        "driver_type": "local_ms_pool",
        "default_auth_mode": "pool",
        "enabled": True,
        "category": "local",
        ...
        "fields": [
            {
                "key": "local_ms_pool_file",
                "label": "Gmail 邮箱池文件路径",
                "placeholder": "D:/下载/gmail-mail-pool.txt",
                "category": "connection",
                "hint": "可选；每行一条 Gmail：邮箱----验证码 API URL。配置文件路径后无需把账号明文粘贴到设置页。",
            },
            {
                "key": "local_ms_pool_text",
                "label": "Gmail 邮箱池文本",
                "type": "textarea",
                "category": "auth",
                "hint": "每行一条：email@gmail.com----https://.../code/fetch?...；也兼容 IMAP 格式。",
            },
            {
                "key": "local_ms_pool_state_file",
                "label": "占用状态文件",
                "placeholder": "data/.local_gmail_mailbox_pool_state.json",
                "default_value": "data/.local_gmail_mailbox_pool_state.json",
                "category": "connection",
                "hint": "用于避免同一个 Gmail 被重复分配；清空该文件可重置占用状态。",
            },
            {
                "key": "local_ms_pool_allow_reuse",
                "label": "允许重复使用邮箱",
            ...
            {
                "key": "local_ms_mailbox_url_timeout",
                "label": "API 请求超时（秒）",
                "placeholder": "15",
                "default_value": "15",
                "category": "connection",
            ...
            {
                "key": "local_ms_mailbox_url_poll_interval",
                "label": "轮询间隔（秒）",
                "placeholder": "2",
                "default_value": "2",
                "category": "connection",
    ...
    },
    {
        ...
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "sms_activate_api_key", "label": "API Key", "secret": True, "category": "auth"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "sms_proxy", "label": "接码请求代理（可选）", "placeholder": "http://127.0.0.1:7897", "hint": "留空时自动复用可用代理池"},
